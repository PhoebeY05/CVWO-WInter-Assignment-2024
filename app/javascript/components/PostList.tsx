...
const PostList = () => {
  ...
  const [posts, setPosts] = useState<{ title: string, author: string, category: string, content: string, id: number, pinned:number, upvote: number, downvote: number, anonymous: boolean }[]>([]);
  const [filtered, setFiltered] = useState<{ title: string, author: string, category: string, content: string, id: number, pinned:number, upvote: number, downvote: number, anonymous: boolean }[]>([]);
